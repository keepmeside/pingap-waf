export default {
  ...
  saveConfigFail: "Save Config Fail",
  moreSettings: "More Settings",
  lessSettings: "Less Settings",
  modified: "modified",
  fetchTomlFailTitle: "Fetch Toml Fail",
  copyConfigFail: "Copy Config Fail",
  copyConfigSuccess: "Copy Config Success",
  ...
  login: {
    ...
    submit: "Login",
    fail: "Login Fail",
    totpTitle: "Second factor",
    totpDescription: "Enter the six-digit code from your authenticator app.",
    totpCode: "Code",
    totpSubmit: "Verify",
    totpFail: "The code was not accepted",
  },
  home: {
    dashboard: "Dashboard",
    ...
    stagePool: "Pool",
    stageOrigin: "Origin",
    stageListenUnit: "servers",
    stageRouteUnit: "locations",
    stagePoolUnit: "upstreams",
    stageOriginUnit: "backends up",
    stageOriginUnitPlain: "backends",
    stageOriginAllUp: "all reachable",
    stageEmpty: "none configured",
    noHealthChecks: "no health checks",
    poolsHealthy: "all pools healthy",
    poolsDegraded: "{{count}} degraded",
    backendsDown: "{{count}} unreachable",
    attention: "Needs attention",
    allClear: "Every upstream is healthy and every certificate is in date.",
    upstreamAllDown: "All {{total}} backends unreachable",
    upstreamDegraded: "{{healthy}} of {{total}} backends healthy",
    certExpired: "Certificate expired {{days}} days ago",
    certExpiresToday: "Certificate expires today",
  ...
  basic: {
    title: "Basic",
    description: "The global settings of pingap, applied to the whole process",
    sectionCore: "Core",
    ...
    listenerTasksPerFdTips:
      "Usually leave at 1 unless you have a specific need.",
  ...
  server: {
    ...
    addrTips:
      "e.g. 0.0.0.0:80, [::]:443 — multiple addresses separated by commas.",
    locations: "Locations",
    locationsPlaceholder: "Select the locations for server",
    locationsTips:
      "Request routes handled by this listener, matched by weight.",
    threads: "Threads",
  ...
  plugin: {
    ...
    adminStore: "Control-plane store",
    adminStorePlaceholder:
      "Path of the database holding admin accounts and sessions",
    adminTotpKey: "TOTP encryption key",
    adminTotpKeyPlaceholder:
      "Key that encrypts 2FA secrets at rest; without it enrolment is refused",
    dirPath: "Directory",
    ...
    keyAuthHideCredentialsPlaceholder:
      "Remove the auth header or query from the request after validation",
    ...
    geoRestrictionMode: "Restriction Mode",
    geoRestrictionCountryCodes: "Country Codes",
